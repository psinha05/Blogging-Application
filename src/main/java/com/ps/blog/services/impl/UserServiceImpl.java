...
import com.ps.blog.entities.User;
import com.ps.blog.exceptions.ResourceNotFoundException;
import com.ps.blog.payloads.UserDto;
import com.ps.blog.repositories.RoleRepo;
import com.ps.blog.repositories.UserRepo;
import com.ps.blog.services.UserService;
...
public class UserServiceImpl implements UserService {
	...
	public User dtoToUser(UserDto userDto) {
		...
		/*
		 * Old way to implement one model to another
		 * Now this has been replaced by ModelMapper
		 * 
	...
	public UserDto userToDto(User user) {
		...
		/*
		 * 
		 * old way to implement one model to another model
		 * 
		 * 
