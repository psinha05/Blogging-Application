 ...
 * SecurityReference("scope", new AuthorizationScope[] { scope })); }
 * 
 * 
 ...
 * 
 * 
 * private ApiInfo getInfo() { return new ApiInfo("Blogging Application",
 * "This project is developed by Prashant S", "1.0", "Terms of Service", new
 * Contact("Prashant", "https://google.com", "psinha@gmail.com"),
